...
# Simple rlisting
res_rl <- as_listing(test_data_rl, key_cols = "ID",
...
test_that("export_as_docx handles list generated by tt_to_flextable(paginate=TRUE)", {
  ...
  expect_true(is.list(result_pages) && !is.data.frame(result_pages),
  ...
  expect_true(all(sapply(result_pages, inherits, "flextable")),
